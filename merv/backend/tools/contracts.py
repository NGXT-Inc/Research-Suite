...
TOOL_CONTRACTS: dict[str, ToolContract] = {
    ...
    "sandbox.request": ToolContract(
        ...
        description=(
            ...
            "checkout's state dir: .research_plugin/sandboxes/keys/ if this "
            "checkout already has a .research_plugin/ directory, otherwise "
            ".merv/sandboxes/keys/. Before writing key material, create the "
