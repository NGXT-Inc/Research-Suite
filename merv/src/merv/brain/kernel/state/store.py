...
MIGRATIONS: tuple[tuple[int, str, str], ...] = (
    ...
    # (like artifact.submit) instead of the local data plane. Versions 28-31 are
    # claimed by parallel lanes (OAuth 28-30, HF 31); 33 is storage's — this cut
    # owns 32 alone. SCHEMA creates the table on fresh DBs; the handler runs the
    # SCHEMA-extracted DDL behind a _has_table gate so ledger and SCHEMA cannot
    # drift.
