...
class SynthesisService:
    ...
    def _parse_change_spec(
        ...
        # Structure comes from the shared domain builders (also used by the
        # resource.validate preflight); the callbacks layer the DB-backed
        # checks only the gate can make.
