...
# agent only ever types `.research_plugin/sbx <sandbox_uid> '<command>'`.
#
...
# Usage: .research_plugin/sbx <sandbox_uid> [command...]
# Connection details live in .research_plugin/sandboxes/conn/<sandbox_uid>
